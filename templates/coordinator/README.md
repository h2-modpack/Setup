...
Modules added to this pack will appear here as separate Thunderstore packages.

## How To Use

Install using r2modman. In game, open the {{WINDOW_TITLE}} menu and configure the modules from the shared settings window.

## More Information

- [Modpack shell repo](https://github.com/{{ORG}}/{{SHELL_REPO}})
