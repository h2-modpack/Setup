...
DEFAULT_SHELL_SECRET_NAMES = ["RELEASE_DISPATCH_TOKEN"]
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Configure GitHub Actions secrets for the shell, coordinator, "
